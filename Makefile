# This Makefile is for the WWW::Spiegel extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/Spiegel.pm]
#     AUTHOR => q[Sebastian Enger <thecerial@>]
#     NAME => q[WWW::Spiegel]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/WWW/Spiegel.pm]
...
PARENT_NAME = WWW
DLBASE = $(BASEEXT)
VERSION_FROM = lib/WWW/Spiegel.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/WWW/Spiegel.pm

PM_TO_BLIB = lib/WWW/Spiegel.pm \
...
DISTNAME = WWW-Spiegel
DISTVNAME = WWW-Spiegel-1.0
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Spiegel.pm $(INST_MAN3DIR)/WWW::Spiegel.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                WWW-Spiegel' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             1.0' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Perl extension for getting news http://www.spiegel.de/' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    - Sebastian Enger <thecerial@>' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for getting news http://www.spiegel.de/</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Sebastian Enger &lt;thecerial@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/WWW/Spiegel.pm blib/lib/WWW/Spiegel.pm 
